      ...
      <div class="w-75 mx-auto p-4 bg-body-tertiary shadow rounded">
        ...
        <form action="" method="POST" class="row g-3" enctype="multipart/form-data">
          ...
          <div class=" col-md-6">
            ...
            <input type="text" id="ram" name="ram" value="<?= ($kapasitasStorageValue) ?? '' ?>" class="form-control">
            <div class="text-danger ps-1">
              <?= $errors['ram'] ?? '' ?>
            </div>
          </div>
          ...
          <div class=" col-md-6">
            <label for="kapasitas-storage" class="form-label">Kapasitas Storage</label>
          ...
          <div class=" col-md-6">
            <label for="kapasitas-baterai" class="form-label">Kapasitas Baterai</label>
